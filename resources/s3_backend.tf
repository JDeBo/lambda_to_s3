...
# S3 BUCKET
# //////////////////////////////
resource "aws_s3_bucket" "main-tfremotestate" {
...
resource "aws_s3_bucket_public_access_block" "main-tfremotestate" {
  bucket = aws_s3_bucket.main-tfremotestate.id
